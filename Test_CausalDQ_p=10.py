from tensorflow.python.ops.gen_dataset_ops import skip_dataset
import sys
...
agent.q_net.load_state_dict(torch.load('q_net_10.pth'))
agent.q_net.eval()
...
for step in range(200):
    ...
    #print(step,"step")
    if statis > 18.3:
        print('The mean shift magnitude is',0.25," and the ALARM Trigger is", step - 70)
        #break
        sys.exit()
...
for step in range(200):
    ...
    #print(step,"step")
    if statis > 18.3:
        print('The mean shift magnitude is',1.5," and the ALARM Trigger is", step - 60)
        #break
        sys.exit()
...
for step in range(200):
    ...
    #print(step,"step")
    if statis > 18.3:
        print('The mean shift magnitude is',2," and the ALARM Trigger is", step - 40)
        #break
        sys.exit()
