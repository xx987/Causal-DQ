...
# mu_c = np.zeros(p)
# mu_c[:q] = 1.5#np.random.rand(q)

mu_c = np.zeros(p)
mu_c[:q] = 0.25 # + np.random.normal(loc=0.0, scale=1, size=q)
np.random.seed(39)
...
mu_c = np.zeros(p)
mu_c[:q] = 0.5 # + np.random.normal(loc=0.0, scale=1, size=q)
np.random.seed(40)
normal_data = np.random.multivariate_normal(
    mean=np.zeros(p),
    cov=cov_matrix,
...
mu_c = np.zeros(p)
mu_c[:q] = 1 # + np.random.normal(loc=0.0, scale=1, size=q)
np.random.seed(40)
normal_data = np.random.multivariate_normal(
    mean=np.zeros(p),
    cov=cov_matrix,
...
mu_c = np.zeros(p)
mu_c[:q] = 1.5 # + np.random.normal(loc=0.0, scale=1, size=q)
np.random.seed(40)
normal_data = np.random.multivariate_normal(
    mean=np.zeros(p),
    cov=cov_matrix,
...
mu_c = np.zeros(p)
mu_c[:q] = 2 # + np.random.normal(loc=0.0, scale=1, size=q)
np.random.seed(40)
normal_data = np.random.multivariate_normal(
    mean=np.zeros(p),
    cov=cov_matrix,
